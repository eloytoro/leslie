...
describe('Seq', () => {
  it('returns the final value', async () => {
    ...
    const result = await Seq.immediate(greet());
  ...
  it('resolves all primitive values', async () => {
    ...
    const [num, str, bool, arr, obj] = await Seq.immediate(gen());
  ...
  it('throws errors', async () => {
    ...
    await expect(Seq.immediate(gen())).eventually.to.be.rejectedWith(err);
  });
